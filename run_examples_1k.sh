...
# out=/data/jiashu/ldg_core/tmp/ldg_core_test/stock1k
# mkdir -p $out
...
# out=/data/jiashu/ldg_core/tmp/ldg_core_test/mcmc1k
# mkdir -p $out
...
out=/data/jiashu/ldg_core/tmp/ldg_core_test/caltech1k
mkdir -p $out
...
# build/ldg_core -d ./data/ldg_data/caltech1k_feat.config --outDir /data/jiashu/ldg_core/tmp/ldg_core_test/caltech1k --distFuncType 2 --repAggregationType 2